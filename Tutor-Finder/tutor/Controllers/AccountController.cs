    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, HttpPostedFileBase upload)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                upload.SaveAs(path);
                var user = new ApplicationUser { Image = upload.FileName,FirstName = model.FirstName, LastName = model.LastName, UserName = model.UserName, Email = model.Email, UserType = model.UserType };
        ...
        public ActionResult EditProfile(EditProfileViewModel profile, HttpPostedFileBase upload)
        {
            if (ModelState.IsValid)
            {
                ...
                //string oldPath = Path.Combine(Server.MapPath("~/Uploads"), CurrentUser.Image);
                ...
                else
                {
                    ...
                    db.SaveChanges();
                    ViewBag.Message = "Account updated successfuly.";
                }
            }
            return View();
        }
